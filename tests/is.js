...
test('default behavior', function (t) {
  ...
  t.deepEqual(fn('nan', 'abc'),           false)
  t.deepEqual(fn('nan', {a:1}),           false)
  t.deepEqual(fn('nan', []),              false)
  t.deepEqual(fn('nan', [1]),             false)
  t.deepEqual(fn('nan', new Number()),    false)
  t.deepEqual(fn('nan', new Number(NaN)), true)
  t.deepEqual(fn('nan', NaN),             true)
  t.deepEqual(fn('nan:true', NaN),        true)
  t.deepEqual(fn('nan:false', NaN),       true)
  t.deepEqual(fn('nan:a', NaN),           true)
  t.deepEqual(fn('nan:12', NaN),          true)
